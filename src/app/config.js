const Config = {
    ...
    static: {
        ...
        edges: [{ "source": 36, "target": 1 }, { "source": 4, "target": 2 }, { "source": 36, "target": 3 }, { "source": 22, "target": 4 }, { "source": 46, "target": 5 }, { "source": 33, "target": 6 }, { "source": 6, "target": 7 }, { "source": 4, "target": 8 }, { "source": 4, "target": 9 }, { "source": 6, "target": 11 }, { "source": 30, "target": 12 }, { "source": 4, "target": 13 }, { "source": 13, "target": 14 }, { "source": 4, "target": 15 }, { "source": 36, "target": 16 }, { "source": 5, "target": 17 }, { "source": 6, "target": 18 }, { "source": 4, "target": 19 }, { "source": 4, "target": 20 }, { "source": 33, "target": 21 }, { "source": 33, "target": 22 }, { "source": 4, "target": 23 }, { "source": 8, "target": 24 }, { "source": 4, "target": 25 }, { "source": 4, "target": 26 }, { "source": 4, "target": 27 }, { "source": 4, "target": 28 }, { "source": 6, "target": 29 }, { "source": 6, "target": 30 }, { "source": 4, "target": 31 }, { "source": 4, "target": 32 }, { "source": 6, "target": 33 }, { "source": 4, "target": 34 }, { "source": 36, "target": 35 }, { "source": 4, "target": 36 }, { "source": 33, "target": 36 }, { "source": 33, "target": 37 }, { "source": 30, "target": 38 }, { "source": 17, "target": 39 }, { "source": 46, "target": 40 }, { "source": 13, "target": 41 }, { "source": 44, "target": 42 }, { "source": 46, "target": 43 }, { "source": 13, "target": 44 }, { "source": 26, "target": 44 }, { "source": 6, "target": 45 }, { "source": 4, "target": 46 }, { "source": 18, "target": 47 }, { "source": 5, "target": 48 }, { "source": 5, "target": 49 }],
        edgesInStateIds: [{ 'source': 'OR', 'target': 'AL' }, { 'source': 'CA', 'target': 'AR' }, { 'source': 'OR', 'target': 'AZ' }, { 'source': 'MN', 'target': 'CA' }, { 'source': 'WA', 'target': 'CO' }, { 'source': 'NY', 'target': 'CT' }, { 'source': 'CT', 'target': 'DE' }, { 'source': 'CA', 'target': 'FL' }, { 'source': 'CA', 'target': 'GA' }, { 'source': 'CT', 'target': 'IA' }, { 'source': 'NJ', 'target': 'ID' }, { 'source': 'CA', 'target': 'IL' }, { 'source': 'IL', 'target': 'IN' }, { 'source': 'CA', 'target': 'KS' }, { 'source': 'OR', 'target': 'KY' }, { 'source': 'CO', 'target': 'LA' }, { 'source': 'CT', 'target': 'MA' }, { 'source': 'CA', 'target': 'MD' }, { 'source': 'CA', 'target': 'ME' }, { 'source': 'NY', 'target': 'MI' }, { 'source': 'NY', 'target': 'MN' }, { 'source': 'CA', 'target': 'MO' }, { 'source': 'FL', 'target': 'MS' }, { 'source': 'CA', 'target': 'MT' }, { 'source': 'CA', 'target': 'NC' }, { 'source': 'CA', 'target': 'ND' }, { 'source': 'CA', 'target': 'NE' }, { 'source': 'CT', 'target': 'NH' }, { 'source': 'CT', 'target': 'NJ' }, { 'source': 'CA', 'target': 'NM' }, { 'source': 'CA', 'target': 'NV' }, { 'source': 'CT', 'target': 'NY' }, { 'source': 'CA', 'target': 'OH' }, { 'source': 'OR', 'target': 'OK' }, { 'source': 'CA', 'target': 'OR' }, { 'source': 'NY', 'target': 'OR' }, { 'source': 'NY', 'target': 'PA' }, { 'source': 'NJ', 'target': 'RI' }, { 'source': 'LA', 'target': 'SC' }, { 'source': 'WA', 'target': 'SD' }, { 'source': 'IL', 'target': 'TN' }, { 'source': 'VA', 'target': 'TX' }, { 'source': 'WA', 'target': 'UT' }, { 'source': 'IL', 'target': 'VA' }, { 'source': 'NC', 'target': 'VA' }, { 'source': 'CT', 'target': 'VT' }, { 'source': 'CA', 'target': 'WA' }, { 'source': 'MA', 'target': 'WI' }, { 'source': 'CO', 'target': 'WV' }, { 'source': 'CO', 'target': 'WY' }],
        regions: {
